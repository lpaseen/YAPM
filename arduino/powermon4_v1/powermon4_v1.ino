/*
 * powermon4 v1, new design and new procedure
 *   no port expander, ad mux direct connected
 *   temp sensor moved
 *   no buffering of data, send it asap
 * 
 *
 * 2017-03-13  Peter Sjoberg <peter.sjoberg@hp.com>
 *	Cloned powermon3_alpha6 and started work on powermon4
 *
...
*/
  ...
  for (channel=0;channel<maxChannels;channel++){
    ...
    case 0: // AC Voltage
      ...
      break; 
    case 1: // main input, different burdenR
    case 2: // main input, different burdenR
...
//      buffvalues[buffhead].valuesummary[channel]=ch_sumI[channel];
      ...
      ch_samplingtime[channel]=ctimenow-ctimethen;
      break;
    default: //the rest of the channels are all the same type
